package com.example.smarthome.ui.chatbot;
...
public class ChatBotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        text_chatbot = view.findViewById(R.id.text_chatbot);

        //final Bundle bundle = getArguments();
        //final String user_name =  bundle.getString("keyname");
        //DatabaseReference reference = FirebaseDatabase.getInstance().getReference("user");
        final Bundle bundle = getArguments();
        final String username =  bundle.getString("keyname");
        text_chatbot.setText(username);
